...
Initializing NFA:
  ...
  Start state: q0
  Final state: q2
  ε-transitions: q0 —ε→ q1, q1 —a→ q1, q1 —b→ q2, q2 —ε→ q0
The method used:
  1. ε-Closure:
    For each state, its ε-closure is computed.
    It represents all states reachable using only ε-transitions, including the state itself.
  ...
  2. New Transitions:
    ...
    So in our example:
      From state q0:
        ...
        On a:
          q1 —a→ q1
          ε-closure(q1) = {q1} → (q0, a) → {q1}
        On b:
          q1 —b→ q2
          ε-closure(q2) = {q2, q0, q1} → (q0, b) → {q0, q1, q2}
      From state q1:
        (q1, a) → {q1}
        (q1, b) → {q0, q1, q2}
      From state q2:
